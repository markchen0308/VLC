export interface iCmd {cmdtype: number,cmdData: any}

export interface iSeqId { seqid?: number }
...
export interface iColorXY { brightness?: number, driverID?: number,colorX?:number,colorY?:number}
